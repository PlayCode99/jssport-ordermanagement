...
export default function CuttingPage({
    ...
    fabricLookup = {},
    specSectionsMap = {},
    initialDepartmentFilter = 'cutting',
...
CuttingPage.layout = (props: { pageTitle?: string; pageHref?: string }) => ({
    breadcrumbs: [
        {
            title: props.pageTitle ?? 'ห้องตัด',
            href: props.pageHref ?? '/production/cutting',
        },
    ],
});
